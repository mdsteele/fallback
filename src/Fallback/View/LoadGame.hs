...
newLoadGameView :: Resources -> View c d -> c -> [SavedGameSummary]
                -> Draw z (View () LoadGameAction)
...
newLoadGameDialog :: Resources -> [SavedGameSummary]
                  -> Draw z (View () LoadGameAction)
...
newSelectedSummaryView :: Resources -> Draw z (View SavedGameSummary a)
